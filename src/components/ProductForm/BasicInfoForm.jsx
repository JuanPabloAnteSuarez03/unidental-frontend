  ...
  return (
    <div style={{ marginBottom: "40px" }}>
      ...
      <div style={{ marginBottom: "20px" }}>
        ...
        >
          Esta es la categoría de inventario (diferente a la categoría SKU)
        </p>
      </div>
      ...
      <div style={{ marginBottom: "20px" }}>
        ...
        >
          Simple: Producto individual | Compuesto: Producto formado por otros
          productos
        </p>
      </div>
      ...
      <div style={{ marginBottom: "20px" }}>
        ...
        >
          ...
          <div>
            ...
            >
              Activar si el producto necesita seguimiento de lotes, fechas de
              vencimiento o códigos de lote específicos
            </p>
          </div>
        </div>
      </div>
