            ...
            <div style={{ marginBottom: "20px" }}>
                ...
                <div>
                    ...
                    >
                        ...
                        {Object.entries(getAvailableSkuCategorias()).map(
                            ([key, value]) => (
                ...
                <div style={{ marginTop: "15px" }}>
                    ...
                    <select
                        ...
                        style={{
                            ...
                            fontSize: "16px",
                            boxSizing: "border-box",
                            backgroundColor: !formData.sku_categoria
                                ? "#f8f9fa"
                                : "#ffffff",
                        }}
                    >
                        ...
                        {Object.entries(getAvailableSubcategorias()).map(
                            ([key, value]) => (
                                <option key={key} value={key}>
                                    {key} - {value}
                                </option>
                ...
                <div style={{ marginTop: "15px" }}>
                    ...
                    >
                        ...
                        {Object.entries(getAvailableTipos()).map(
                            ([key, value]) => (
                                <option key={key} value={key}>
                                    {key} - {value}
                                </option>
                            ...
                            style={{
                                ...
                                backgroundColor: getSkuRequirements().canOperate
                                    ? isGeneratingSku
                                        ...
                                        : "#007bff"
                                    : "#e9ecef",
                                color: getSkuRequirements().canOperate
                                    ? "white"
                                    : "#6c757d",
                                fontSize: "14px",
                                cursor: getSkuRequirements().canOperate
                                    ? isGeneratingSku
                                        ...
                                        : "pointer"
                                    : "not-allowed",
                                opacity: getSkuRequirements().canOperate
                                    ? 1
                                    : 0.6,
                                whiteSpace: "nowrap",
