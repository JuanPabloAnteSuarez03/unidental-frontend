    ...
    <div style={{ minHeight: "100vh", fontFamily: "Arial, sans-serif" }}>
      ...
      >
        <div className="logo-area" style={{ flexShrink: 0 }}>
          <h1 style={{ margin: 0, fontSize: "1.8em" }}>Sistema de Gestión</h1>
          <h2
            style={{
              margin: "0.2em 0 0 0",
              fontSize: "1em",
            ...
            >
              {Object.keys(menus).map((menuId) => (
                <div
                  ...
                  style={{
                    position: "relative",
                    marginRight: menuId === "configuracion" ? "0" : "25px",
                  }}
                ...
                >
                  <div
                    style={{
                      ...
                      borderRadius: "4px",
                      backgroundColor:
                        activeMenu === menuId ? "#3a506b" : "transparent",
                    }}
                  >
                    {menus[menuId].title} ▼
                  </div>
                      ...
                      {menus[menuId].items.map((item, index) => (
                        <Link
                          ...
                          style={{
                            ...
                            color: "#333",
                            borderBottom:
                              index < menus[menuId].items.length - 1
                                ? "1px solid #eee"
                                : "none",
                            backgroundColor:
                              hoveredItem === `${menuId}-${index}`
                                ? "#e0e0e0"
                                : "transparent",
                            transition: "background-color 0.2s ease",
                          }}
                          onMouseEnter={() =>
                            setHoveredItem(`${menuId}-${index}`)
                          }
      ...
      >
        <p style={{ margin: 0, color: "#34495e" }}>
          &copy; {new Date().getFullYear()} Sistema de Inventario Unidental
        </p>
      </footer>
    </div>
  );
