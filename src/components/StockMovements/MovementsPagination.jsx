      ...
      >
        ...
        <span>
          ...
          <strong style={{ color: "#2c3e50" }}>
            {movementsTotalCount > 0 
              ? Math.min(25 * (Math.max(1, movementsCurrentPage) - 1) + 1, movementsTotalCount)
              : 0}
            -{Math.min(25 * Math.max(1, movementsCurrentPage), movementsTotalCount)}
          </strong>{" "}
          de <strong style={{ color: "#2c3e50" }}>{movementsTotalCount}</strong>{" "}
          movimientos
          {movementsTotalPages > 1 && (
      ...
      >
        ...
        <button
          ...
          style={{
            ...
            backgroundColor: movementsCurrentPage > 1 ? "#fff" : "#f8f9fa",
            borderRadius: "8px",
            color: movementsCurrentPage > 1 ? "#2c3e50" : "#6c757d",
            cursor: movementsCurrentPage > 1 ? "pointer" : "not-allowed",
            fontSize: "14px",
            fontWeight: "500",
        ...
        {Array.from(
          ...
          (_, i) => {
            const pageNum = Math.max(1, movementsCurrentPage - 2) + i;
            ...
            return (
              <button
                ...
                style={{
                  padding: "10px 14px",
                  border: `2px solid ${
                    pageNum === movementsCurrentPage ? "#2c3e50" : "#e9ecef"
                  }`,
                  backgroundColor:
                    pageNum === movementsCurrentPage ? "#2c3e50" : "#fff",
                  borderRadius: "8px",
                  color: pageNum === movementsCurrentPage ? "#fff" : "#2c3e50",
                  cursor: "pointer",
                  fontSize: "14px",
                  fontWeight: "600",
                  minWidth: "44px",
        ...
        <button
          ...
          style={{
            ...
            border: "2px solid #e9ecef",
            backgroundColor:
              movementsCurrentPage < movementsTotalPages ? "#fff" : "#f8f9fa",
            borderRadius: "8px",
            color:
