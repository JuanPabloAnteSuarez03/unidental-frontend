        ...
        onProductSelect={(product) => {
          ...
          if (product.supplier) {
            ...
            if (foundSupplier) {
              ...
              if (selectedSupplier && currentSupplierId !== newSupplierId) {
              ...
              alert("Error: No se pudo identificar el proveedor del producto");
            }
          } else {
            console.warn("⚠️ Producto sin información de proveedor");
            alert("Error: El producto no tiene información de proveedor");
          }
        }}
