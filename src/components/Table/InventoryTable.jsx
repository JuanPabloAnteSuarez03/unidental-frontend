...
const InventoryTable = ({
  ...
  const styles = useMemo(
    () => ({
      ...
      // 🚀 NUEVO: Indicador de carga de precios de compra
      purchasePricesLoadingBanner: {
  ...
  return (
    <div style={styles.container}>
      ...
      {isPurchasePricesLoading && (
        <div style={styles.purchasePricesLoadingBanner}>
          <div style={styles.stockLoadingSpinner}></div>
          <span>💰 Cargando precios de compra...</span>
        </div>
      )}
          ...
          <tbody>
            {products.map((product, index) => (
              <TableRow
                ...
                product={product}
                index={index}
                isStockLoading={product.stockLoading || isStockLoading}
